...
```bash
curl -H "Content-Type: application/json" -d '{"DisplayName": "Example Cluster" "ResourceType": "k8s-cluster", "LocalId": "1", "Spec": {"ApiServer": "www.example.com/api-server"}}}' http://localhost:9080/api/inventory/v1.0/resources
```
